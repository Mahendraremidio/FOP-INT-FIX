...
#define TIMER_LED_ON                    (500 * MILLISECOND) 
...
bool Flag0 =0, Flag1=0, Flag2=0, Flag3=0,Flag4=0,Flag5=0,Flag6=0,Flag7=0,Adp,Chg,state_led;
    ...
    switch(g_app_data.state)
    {
        case app_state_connected:
        {
                     ...
                     case 0x57:
                      ...
                      case 0x49:
                           ...
                           
                            {
                              io_led = (uint8)*ch++;
                                switch(io_led)
                                { /*D3-Down right led in a FIX LED board(10&11 commands to off and On*/
                                    case 0x00:
                                              {
                                                ...
                                                PioSetMode(Fixation_databit_3, pio_mode_user);         /*000 ====================> State-0 */
                                                PioSetDir(Fixation_databit_3, PIO_DIRECTION_OUTPUT);
                                                PioSetPullModes((1UL<<Fixation_databit_3), pio_mode_strong_pull_up);
                                                PioSet(Fixation_databit_3,FALSE);
                                    ...
                                    case 0x01:
                                              {
                                                ...
                                                PioSetDir(Fixation_databit_3, PIO_DIRECTION_OUTPUT);
                                                PioSetPullModes((1UL<<Fixation_databit_3), pio_mode_strong_pull_up);
                                                PioSet(Fixation_databit_3,TRUE);
                                                
                                              
                                              }
                                              break;
                                              /*D1-Up right led in a FIX LED board(12&13 commands to off and On*/
                                    case 0x02:
                                              {
                                    ...
                                    case 0x03:
                                              ...
                                              /*D7-Up left led in a FIX LED board(4&5 commands to off and On*/
                                    case 0x04:
                                              {
          ...
          {  
            ...
            state_led =  VFPWMStart(0xFF,w_int);
...
extern void white(void)
{
    ...
    temp_white = 0x64;  
        ...
        GattCharValueNotification(GetConnectionID(),HANDLE_SERIAL_DATA_TRANSFER,1,&temp_white); 
...
static void handler(timer_id const id)
{
                    ...
                    /*  const uint16 mvs1 = AioRead(2);
                 
                  writeASCIICodedNumber(mvs1);
